...
import { IFamille, Famille } from 'app/shared/model/backend/famille.model';
...
describe('Service Tests', () => {
    describe('Famille Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Famille(0, 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Famille', async () => {
            ...
            it('should delete a Famille', async () => {
