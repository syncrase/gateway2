...
import { IReference, Reference } from 'app/shared/model/backend/reference.model';
...
describe('Service Tests', () => {
    describe('Reference Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ReferenceService);
            httpMock = injector.get(HttpTestingController);

            elemDefault = new Reference(0, 'AAAAAAA');
        });
