...
import { ClassificationCronquistDeleteDialogComponent } from 'app/entities/backend/classification-cronquist/classification-cronquist-delete-dialog.component';
