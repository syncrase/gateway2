...
import { ILivre, Livre } from 'app/shared/model/backend/livre.model';
...
describe('Service Tests', () => {
    describe('Livre Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Livre(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 0);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Livre', async () => {
            ...
            it('should return a list of Livre', async () => {
                const returnedFromService = Object.assign(
                    {
                        description: 'BBBBBB',
                        isbn: 'BBBBBB',
