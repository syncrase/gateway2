...
import { GenreDeleteDialogComponent } from 'app/entities/backend/genre/genre-delete-dialog.component';
import { GenreService } from 'app/entities/backend/genre/genre.service';
