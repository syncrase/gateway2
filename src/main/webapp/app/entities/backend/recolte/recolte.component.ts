...
export class RecolteComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.recolteService
            ...
            .subscribe(
                (res: HttpResponse<IRecolte[]>) => this.paginateRecoltes(res.body, res.headers),
    ...
    protected paginateRecoltes(data: IRecolte[], headers: HttpHeaders) {
