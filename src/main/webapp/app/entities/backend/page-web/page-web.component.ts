...
export class PageWebComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.pageWebService
            ...
            .subscribe(
                (res: HttpResponse<IPageWeb[]>) => this.paginatePageWebs(res.body, res.headers),
    ...
    protected paginatePageWebs(data: IPageWeb[], headers: HttpHeaders) {
