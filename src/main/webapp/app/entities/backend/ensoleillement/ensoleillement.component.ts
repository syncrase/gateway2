...
export class EnsoleillementComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.ensoleillementService
            ...
            .subscribe(
                (res: HttpResponse<IEnsoleillement[]>) => this.paginateEnsoleillements(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/ensoleillement'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    protected paginateEnsoleillements(data: IEnsoleillement[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.queryCount = this.totalItems;
        this.ensoleillements = data;
    }
