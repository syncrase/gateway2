...
export class StrateComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.strateService
            ...
            .subscribe(
                (res: HttpResponse<IStrate[]>) => this.paginateStrates(res.body, res.headers),
    ...
    protected paginateStrates(data: IStrate[], headers: HttpHeaders) {
