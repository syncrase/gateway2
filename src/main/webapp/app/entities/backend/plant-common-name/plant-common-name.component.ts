...
export class PlantCommonNameComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.plantCommonNameService
            ...
            .subscribe(
                (res: HttpResponse<IPlantCommonName[]>) => this.paginatePlantCommonNames(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/plant-common-name'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    protected paginatePlantCommonNames(data: IPlantCommonName[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.queryCount = this.totalItems;
        this.plantCommonNames = data;
    }
