...
export class TypeTerreComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.typeTerreService
            ...
            .subscribe(
                (res: HttpResponse<ITypeTerre[]>) => this.paginateTypeTerres(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/type-terre'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    protected paginateTypeTerres(data: ITypeTerre[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.queryCount = this.totalItems;
        this.typeTerres = data;
    }
