...
import { OrdreService } from 'app/entities/backend/ordre';
import { IFamille } from 'app/shared/model/backend/famille.model';
import { FamilleService } from 'app/entities/backend/famille';
import { IGenre } from 'app/shared/model/backend/genre.model';
import { GenreService } from 'app/entities/backend/genre';
import { IEspece } from 'app/shared/model/backend/espece.model';
import { EspeceService } from 'app/entities/backend/espece';
