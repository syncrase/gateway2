...
export class ClassificationCronquistComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.classificationCronquistService
            ...
            .subscribe(
                (res: HttpResponse<IClassificationCronquist[]>) => this.paginateClassificationCronquists(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/classification-cronquist'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    protected paginateClassificationCronquists(data: IClassificationCronquist[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.queryCount = this.totalItems;
        this.classificationCronquists = data;
    }
