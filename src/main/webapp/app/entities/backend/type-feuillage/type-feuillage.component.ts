...
export class TypeFeuillageComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.typeFeuillageService
            ...
            .subscribe(
                (res: HttpResponse<ITypeFeuillage[]>) => this.paginateTypeFeuillages(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/type-feuillage'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    protected paginateTypeFeuillages(data: ITypeFeuillage[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.queryCount = this.totalItems;
        this.typeFeuillages = data;
    }
