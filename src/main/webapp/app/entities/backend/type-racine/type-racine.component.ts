...
export class TypeRacineComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.typeRacineService
            ...
            .subscribe(
                (res: HttpResponse<ITypeRacine[]>) => this.paginateTypeRacines(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/type-racine'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    protected paginateTypeRacines(data: ITypeRacine[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.queryCount = this.totalItems;
        this.typeRacines = data;
    }
